...
BASE_DIR = os.path.dirname(os.path.abspath(__file__)) #used to get the directory name from the specified path
db_dir = (BASE_DIR + '\\Form.db')


class Login:
    def __init__(self, root):# method is the equivalent of the c++ constructor in an object-oriented approach. Is called every time an object is created from a class
        self.root = root
        ...
        x = (self.root.screen_width / 2) - (self.root.app_width / 2) #used to place the user interface at the center of the screen
        ...
        self.root = Image.open("Lucykam.jpg")
        ...
        title = Label(Frame_Login, text="Login Here", font=("impact", 35, "bold"), fg="#6162FF", bg="white").place(x=90,
                                                                                                                   y=30)
        subtitle = Label(Frame_Login, text="Admin Login", font=("Goudy Old style", 15, "bold"), fg="#1d1d1d",
                         bg="white").place(x=90, y=100)

        # username
        lbl_user = Label(Frame_Login, text="Username", font=("Goudy Old style", 15, "bold"), fg="black",
                         bg="white").place(x=90, y=140)
        self.username = Entry(Frame_Login, font=("Goudy Old style", 15,), bg="#E7E6E6")
        self.username.place(x=90, y=170, width=320, height=35)
        # Password
        lbl_Password = Label(Frame_Login, text="Password", font=("Goudy Old style", 15, "bold"), fg="black",
